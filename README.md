...
Instructions on how to effectively use the DNABERT-Enhancer model.
  ...
  - #### Model Highlights:<img src="https://github.com/DavuluriLab/DNABERT_Enhancer/tree/main/Figures/PM.png" alt="Alt text" title="Performance metrics of the two DNABERT-Enhancer models">
